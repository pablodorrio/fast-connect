...
function checkUserLocation() {
    return new Promise((resolve, reject) => {
        // Simulación de la Device Location Verification API
        if (navigator.geolocation) {
            // En una aplicación real usaríamos navigator.geolocation.getCurrentPosition
            // pero para simular diferentes resultados haremos lo siguiente:
